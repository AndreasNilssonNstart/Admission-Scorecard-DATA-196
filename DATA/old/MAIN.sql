...
WITH MaxDates AS (
    ...
    WHERE
        A.Status = 'DISBURSED'  and A.HasCoapp = 0  --and A.CoappSameAddress = 0 -- and A.ApplicationID = 5007968
...
WHERE
    A.Status = 'DISBURSED' --and A.ApplicationID = 5000245
